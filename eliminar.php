...
while ($fila = mysqli_fetch_assoc($resultado)) {
    ...
    echo "<input class='confirm' type='submit' name='eliminar' value='Eliminar' onclick='evaluarEliminacion()'>";
    echo "</form>";
    echo "</td>";
    echo "</tr>";
}
...
echo "</table>";
echo "<button class='eliminate'>Eliminar Registros</button>";
echo "</div>";
echo "</body>";
echo "</html>";
    ...
    function evaluarEliminacion() {
        if (confirmarEliminacion()) {
            ...
            if ($_POST['eliminar']) {
                ...
                echo "<div style='font-size: 20px; text-align: center;'><b>Se canceló la Eliminación<b></div>";
            }
        } else {
